import { forwardRef, type MouseEventHandler, useEffect, useMemo } from 'react';
import { MatrixError, type Room, type IHierarchyRoom } from '$types/matrix-sdk';
import { Box, config, Text } from 'folds';
import {
  type HierarchyItem,
  type HierarchyItemRoom,
