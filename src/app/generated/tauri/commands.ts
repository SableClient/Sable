 ...
 * Generated at: 2026-07-24T22:15:12.812803410+00:00
 * Generator: none
 *
...
export async function abortNativeFetch(params: types.AbortNativeFetchParams): Promise<void> {
  return invoke('abort_native_fetch', params);
}
...
export async function nativeFetch(params: types.NativeFetchParams): Promise<unknown> {
  return invoke('native_fetch', params);
}
