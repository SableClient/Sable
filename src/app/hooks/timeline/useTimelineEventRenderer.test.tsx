...
// ── Global mocks (applied once, no dynamic rAF/ResizeObserver etc.) ────────
...
// ── Stub leaf components so snapshot focuses on renderer branching ─────────
...
vi.mock('$features/room/message', async (importActual) => {
  ...
  return {
    ...
    // Stub EncryptedContent minimally
    EncryptedContent: () => <div data-testid="encrypted-content" />,
    // Stub Reactions minimally
...
// ── MatrixEvent factory (covers ALL methods called by the renderer) ────────
...
// ── MatrixClient / PushProcessor mocks ─────────────────────────────────────
...
// ── Helper: render an event through the hook ───────────────────────────────
