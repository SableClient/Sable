...
export const SystemEmoji = style({
  selectors: {
    '&&': {
      ...
      height: '1em',
      minWidth: '1em',
      fontSize: 'var(--sable-system-emoji-font-size, 1em)',
      lineHeight: '1em',
      verticalAlign: 'middle',
      position: 'relative',
      top: 'var(--sable-system-emoji-top, -0.1em)',
      textAlign: 'center',
    },
  },
});
...
export const CustomEmoticon = recipe({
  base: [
    DefaultReset,
    {
      ...
      height: '1em',
      minWidth: '1em',
      fontSize: 'var(--sable-custom-emoji-font-size, 1em)',
      lineHeight: '1em',
      verticalAlign: 'var(--sable-custom-emoji-align, 0)',
      borderRadius: config.radii.R300,
    },
  ],
  variants: {
